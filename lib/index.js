...
exports.TRPG = exports.Config = exports.name = void 0;
const koishi_1 = require("koishi");
const types_1 = require("./types");
const database_1 = require("./database");
const dice_1 = require("./logic/dice");
exports.name = 'trpg-core';
exports.Config = koishi_1.Schema.object({
    attributes: koishi_1.Schema.array(String)
        .default(['力量', '敏捷', '体质', '智力', '意志', '魅力', '教育', '幸运'])
        .description('默认人物卡属性模板'),
    commands: koishi_1.Schema.object({
        roll: koishi_1.Schema.array(String).default(['r', 'roll']).description('掷骰指令别名'),
        check: koishi_1.Schema.array(String).default(['ra', 'check']).description('检定指令别名'),
        char: koishi_1.Schema.array(String).default(['st', 'char']).description('人物卡/属性录入指令别名'),
    }).description('指令设置'),
});
class TRPG extends types_1.TRPGService {
    constructor(ctx, config) {
        super(ctx);
        this.config = config;
        // Extend Database
        (0, database_1.applyDatabase)(ctx);
        // Register Commands
     ...
     * Save/Update
     */
    async saveCharacter(userId, data) {
     ...
     */
    async roll(expression, ruleId) {
        // TODO: Integrate RulePack specific logic
        const res = (0, dice_1.rollDice)(expression);
        return {
            outcome: 'roll',
