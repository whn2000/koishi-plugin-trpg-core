...
import { makeArray, remove, trimSlash } from "cosmokit";
...
var Server = class extends KoaRouter {
  constructor(ctx, config) {
    ...
    this._body = async (c, next) => {
      if (c[/* @__PURE__ */ Symbol.for("isBodyParsed")]) return next();
      c[/* @__PURE__ */ Symbol.for("isBodyParsed")] = true;
      await body(c, next);
    };
  ...
  register(...args) {
    ...
    if (!args[2][0][/* @__PURE__ */ Symbol.for("noParseBody")]) {
